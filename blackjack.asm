...
gameloop:
	...
	CompareDealerAndUser:	# Dealer number of cards is in $s7 and user's number of cards is in $s6
	la $a0, Cards	
	move $a1, $s6
	jal CalculateSum	
